...
Cohesion: 0.10
Nodes (38): Step 3 — Merchant shop, react-tooltip, addComponent, buyComponent, buyGear, freshMerchant(), gameReducer, initState (+30 more)
...
### Community 7 - "vitest"
Cohesion: 0.05
Nodes (46): @testing-library/react, vitest, LabelledContainer, styles, HudUnderTest, readAllSaves(), readSave(), removeSave() (+38 more)
...
Cohesion: 0.09
Nodes (21): phaser, CirclingConfig, EnemyStates, HitParams, MoveOptions, Crafting, CraftingConfig, ActiveCast (+13 more)

### Community 13 - "BiomeScene.ts"
Cohesion: 0.15
Nodes (17): rxjs, AssignClass, PlayerType, MapStateOptions, mapStateToData(), state$, BIOME_IDS, BiomeId (+9 more)
...
### Community 17 - "CharacterCard.tsx"
Cohesion: 0.43
...
Cohesion: 0.12
Nodes (25): react-redux, GameState, RootState, ComponentStack, Coins(), CoinsProps, src_ui_components_atoms_coins_module, ComponentsGrid() (+17 more)
...
Cohesion: 0.10
Nodes (13): Collision, Layers, Loading, Regenerating the biome maps, Tilemaps, AnimationConfig, createAnimations(), EnemyConfig (+5 more)
...
Cohesion: 0.16
Nodes (5): WalkabilityGrid, BiomeDefinition, BiomeScene, toggleHUD, EnemyType
...
### Community 39 - "react"
Cohesion: 0.10
Nodes (30): Step 1 — Shop skeletons: open & close every shop (this PR), react, buyLoot, switchUi, toggleFilter, Button(), ButtonProps, src_ui_components_atoms_button_module (+22 more)
...
Cohesion: 0.22
Nodes (12): AREA_LIVE_CAP, AREA_TOTAL_ENEMIES, BOSS_SCALING, promoteToBoss(), scaleLootTable(), SPAWN_CONE_HALF_ANGLE_DEG, SPAWN_MOVING_SPEED, SPAWN_RADIUS_MARGIN (+4 more)

### Community 45 - "Player.ts"
Cohesion: 0.12
Nodes (11): Destination, DrawBarOptions, AssignResource(), AssignResourceType, AssignSpell, Weapon, WeaponConfig, addXP (+3 more)
...
Cohesion: 0.19
Nodes (16): equipLoot, selectLoot, unequipLoot, LootItem, DroppableSlot(), DroppableSlotProps, src_ui_components_atoms_droppableslot_module, Loot() (+8 more)
...
Cohesion: 0.10
Nodes (17): react-dnd, react-dnd-touch-backend, react-dom, container, PhaserGame, src_styles_globals, LootIcon(), LootIconProps (+9 more)
...
Cohesion: 0.36
Nodes (5): buildWalkability(), isFootprintSpawnable(), Rect, grid(), WalkabilityInput
...
Cohesion: 0.18
Nodes (3): EnemyStats, Monster, EnemyAttributes
...
Cohesion: 0.12
Nodes (15): getResourceColour(), src_ui_components_atoms_slot_module, Slot(), SlotComponentProps, SlotProps, src_ui_components_molecules_statbar_module, StatBar(), StatBarProps (+7 more)

### Community 149 - "Gem.ts"
Cohesion: 0.11
Nodes (10): Coin, COIN_BASE_VALUE, CoinConfig, Gem, GEM_BASE_VALUE, GemConfig, GemUnderTest, coinValue() (+2 more)
...
- **Why does `vitest` connect `vitest` to `gameReducer.ts`, `generateItem.ts`, `Item.ts`, `BiomeScene.ts`, `Character.tsx`, `store/index.ts`, `CastingController`, `Gem.ts`, `package.json`, `game.ts`, `Enemy.test.ts`, `operations/helpers.ts`, `SpellButton`, `handlers.test.ts`, `classes.ts`, `generateItem.test.ts`, `SnareTrap`, `vite.config.ts`, `react`, `TownScene.test.ts`, `area.ts`, `Spell.test.ts`, `Resource`, `Projectile`, `spawnGeometry.ts`, `walkability.ts`, `CastBar`, `statConversion.ts`, `BiomeScene.test.ts`, `Invocation`, `Player.test.ts`?**
  _High betweenness centrality (0.202) - this node is a cross-community bridge._
- **Why does `phaser` connect `Enemy.ts` to `Player`, `AssignSpell.ts`, `vitest`, `Frostbolt.ts`, `BiomeScene.ts`, `CastingController`, `Gem.ts`, `package.json`, `game.ts`, `SpellButton`, `LoadScene.ts`, `TownScene.test.ts`, `Player.ts`, `Spell.test.ts`, `AssignClass.ts`, `Resource`, `Projectile`, `CastBar`, `PhaserGame.tsx`, `Hero`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `Enemy` connect `Enemy` to `Player`, `AssignSpell.ts`, `EnemyOptions`, `.constructor`, `SnareTrap`, `Healer`, `Boss.ts`, `.setCircling`, `Consecration`, `Enemy.ts`, `Player.ts`, `Boons.ts`, `area.ts`, `Frostbolt.ts`, `game.ts`, `Enemy.test.ts`, `Projectile`, `SiphonSoul`?**
