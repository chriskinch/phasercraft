...
import TilesetOrganic from '../Graphics/maps/tileset_organic.png';
import EnchantedForrestJSON from '../Graphics/maps/enchanted_forrest_map.json';
...
class LoadScene extends Phaser.Scene {
	...
	preload(){
		...
		this.load.image('tileset_organic', TilesetOrganic);
		this.load.tilemapTiledJSON('enchanted_forrest', 'http://192.168.1.100:8081/maps/enchanted_forrest_map.json');
