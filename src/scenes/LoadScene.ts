...
export default class LoadScene extends Scene {
    ...
    preload() {
        ...
        this.load.spritesheet("cleric", "spritesheets/player/cleric.gif", {
            frameWidth: 24,
            frameHeight: 32,
        });
        this.load.spritesheet("mage", "spritesheets/player/mage.gif", {
            frameWidth: 24,
            frameHeight: 32,
        });
        this.load.spritesheet("occultist", "spritesheets/player/occultist.gif", {
            frameWidth: 24,
            frameHeight: 32,
        });
        this.load.spritesheet("ranger", "spritesheets/player/ranger.gif", {
            frameWidth: 24,
            frameHeight: 32,
        });
        ...
        this.load.spritesheet("coin-spin", "spritesheets/coin.png", {
            frameWidth: 16,
            frameHeight: 16,
        });
        this.load.spritesheet("gem-shine", "spritesheets/gem.png", {
            frameWidth: 32,
            frameHeight: 28,
        });
        ...
        this.load.spritesheet("faith-effect", "spritesheets/spells/heal.png", {
            frameWidth: 192,
            frameHeight: 192,
        });
        this.load.spritesheet("siphonsoul-effect", "spritesheets/spells/heal.png", {
            frameWidth: 192,
            frameHeight: 192,
        });
        this.load.spritesheet("earthshield-effect", "spritesheets/spells/earthshield.png", {
            frameWidth: 150,
            frameHeight: 105,
        });
        this.load.spritesheet("manashield-effect", "spritesheets/spells/manashield.png", {
            frameWidth: 50,
            frameHeight: 50,
        });
        this.load.spritesheet("fireball-effect", "spritesheets/spells/fireball.png", {
            frameWidth: 87,
            frameHeight: 87,
        });
        ...
        this.load.atlas(
            "siphon-soul",
            "atlas/spells/atlas-siphonsoul.png",
            "atlas/spells/atlas-siphonsoul.json"
        );
        this.load.spritesheet("smite-effect", "spritesheets/spells/smite.gif", {
            frameWidth: 100,
            frameHeight: 129,
        });
        this.load.image("snare-trap", "spritesheets/spells/snaretrap.gif");
        this.load.spritesheet("multishot-effect", "spritesheets/swoosh.png", {
            frameWidth: 32,
            frameHeight: 32,
        });
        ...
        this.load.image(
            ...
            "tilesets/forestVillage/forestVillageStructures_ [stallsWatchtower].png"
        );
        ...
        this.load.image(
            ...
            "tilesets/fantasy/forest_/forest_ [bridgeHorizontal].png"
        );
        this.load.image(
            "forestBridgeVertical",
            "tilesets/fantasy/forest_/forest_ [bridgeVertical].png"
        );
        this.load.image(
            "forestFencesAndWalls",
            "tilesets/fantasy/forest_/forest_ [fencesAndWalls].png"
        );
        ...
        this.load.image(
            "outdoor_tables",
            "tilesets/forestVillage/props_/forestVillageObjects_outdoor_tables.png"
        );
        ...
        this.load.image(
            "bench_long",
            "tilesets/forestVillage/props_/forestVillageObjects_bench_long.png"
        );
        ...
        this.load.spritesheet(
            "container_stacks",
            "tilesets/forestVillage/props_/forestVillageObjects_container_stacks.png",
            {
                frameWidth: 32,
                frameHeight: 32,
                margin: 0,
        ...
        this.load.spritesheet(
            "containers",
            "tilesets/forestVillage/props_/forestVillageObjects_containers.png",
            {
                frameWidth: 16,
                frameHeight: 32,
                margin: 0,
        ...
        this.load.spritesheet(
            "forest_bushes_rocks",
            "tilesets/fantasy/forest_/forest_resources_bushes_rocks_ores.png",
            {
                frameWidth: 16,
                frameHeight: 16,
                margin: 0,
        ...
        this.load.spritesheet(
            "forest_trees",
            "tilesets/fantasy/forest_/forest_resources_trees.png",
            {
                frameWidth: 16,
                frameHeight: 32,
                margin: 0,
    ...
    create() {
        ...
        // SelectScene is the passive listener that starts BiomeScene once a
